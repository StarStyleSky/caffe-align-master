#ifndef CAFFE_pSROI_ALIGN_POOING_LAYER_HPP_
#define CAFFE_pSROI_ALIGN_POOING_LAYER_HPP_
...
class PSROIAlignPoolingLayer : public Layer<Dtype> {
 public:
  explicit PSROIAlignPoolingLayer(const LayerParameter& param)
    : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "PSROIAlignPooling"; }
...
#endif  // CAFFE_pSROI_ALIGN_POOING_LAYER_HPP_
